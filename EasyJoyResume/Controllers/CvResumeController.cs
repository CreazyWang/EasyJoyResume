            ...
            else//加载用户简历
            {
                ...
                if (itemid == 206)
                {
                    ...
                    resume_Base = new resume_base
                    {
                        ...
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "个人主页", key = "base_home" },
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "社交账号", key = "base_social" },
                        ...
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "实习经验", key = "resume_internship" },
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "志愿者经历", key = "resume_volunteer" },
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "项目经验", key = "resume_project" },
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "荣誉奖项", key = "resume_honor" },
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "自我评价", key = "resume_summary" },
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "作品展示", key = "resume_portfolio" },
                        new modul_item_show() { isShow = true, isTitleShow = true, isContentShow = true, title = "二维码", key = "resume_qrcode" }
                        ),
