...
namespace EasyJoyResume.Utility
{
    ...
    public class PageValidate
    {
        ...
        private static Regex RegPassword = new Regex("[\\w-]+$"); 
        ...
        public static bool CheckPssword(string inputData)
        {
        ...
        {
            string[] list = new string[] { "123456", "654321", "concat", "group_concat", "concat_ws","select" };
